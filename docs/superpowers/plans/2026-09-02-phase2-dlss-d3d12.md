...
- [ ] **Step 1: Replace the renderer gate in `src\RenderforgeMod.cs`**
...
- [ ] **Step 2: Add the `Api()` wrapper to `src\Native.cs`**
...
- [ ] **Step 3: Drop the "Phase 2" arm in `src\Availability.cs`**
...
- [ ] **Step 4: Surface the API in `DlssDriver.Status`**
...
- [ ] **Step 5: Build the managed assembly**
