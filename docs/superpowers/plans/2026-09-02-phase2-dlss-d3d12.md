...
- [ ] **Step 1: Add the two diagnostic imports to `src\Native.cs`**
...
- [ ] **Step 2: Log the interface state under D3D12**
...
- [ ] **Step 3: Build and deploy to the automation install**
...
- [ ] **Step 4: Launch the automation install under D3D12 and read the log**
...
- [ ] **Step 5: FALLBACK, only if Step 4 printed `unityIface=0`**
