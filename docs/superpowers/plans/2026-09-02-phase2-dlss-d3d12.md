...
- [ ] **Step 5: Read both screenshots and compare** — FAIL 2026-09-02: D3D12 DLAA/Quality output is near-black (same camera, DLSS Off under D3D12 is lit normally); Sharpness 0 washes the whole frame incl. HUD grey. HUD intact otherwise.
...
- [ ] **Step 7: In-game A/B on the sharpness slider** — run 2026-09-02: status `sharpen=NIS lastError=0`, but sharp0 = whole frame washed grey (HUD too), sharp100 = near-black scene; not judgeable until the D3D12 output is right.
