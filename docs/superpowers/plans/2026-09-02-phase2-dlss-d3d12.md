...
- [ ] **Step 1: Add the sharpen state to `Device12`**
...
- [ ] **Step 2: Add the sharpen methods**
...
- [ ] **Step 4: Release the sharpen objects in `Shutdown`**
...
- [ ] **Step 5: Assert the sharpener in the D3D12 probe**
...
- [ ] **Step 6: Build and run both probes**
