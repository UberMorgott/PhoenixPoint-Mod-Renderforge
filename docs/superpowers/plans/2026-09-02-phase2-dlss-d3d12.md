...
- [ ] **Step 7: Stability gate — 3 mission loads** — FAIL 2026-09-02: process died (device removed) before the loop could run; longest D3D12 tactical life with DLSS on ≈ 60 s.
...
- [ ] **Step 8: If anything failed, log a PPCLI defect only when PPCLI itself misbehaved**
