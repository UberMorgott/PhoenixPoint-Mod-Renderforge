...
- [ ] **Step 2: Write `native\unity\IUnityInterface.h`**
...
- [ ] **Step 3: Write `native\unity\IUnityGraphics.h`**
...
- [ ] **Step 4: Write `native\unity\IUnityGraphicsD3D12.h`**
...
- [ ] **Step 5: Add the D3D12 link and the vendored headers to CMake**
...
- [ ] **Step 6: Configure + build to prove nothing broke**
