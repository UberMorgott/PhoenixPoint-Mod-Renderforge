...
- [ ] **Step 2: Write `native\Device11.cpp` (the current D3D11 code, moved)**
...
- [ ] **Step 3: Add the new codes and exports to `native\RenderforgeNative.h`**
...
- [ ] **Step 4: Rewrite `native\RenderforgeNative.cpp` as the ABI layer only**
...
- [ ] **Step 5: Add a stub `Device12.cpp` so the project links**
...
- [ ] **Step 6: Build and run the D3D11 probe — output must be unchanged**
