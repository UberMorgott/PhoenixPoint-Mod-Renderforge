...
// Main thread, same slot contract as Dlss_SetColorVision. Exposure / Levels / Brightness / Contrast / Clarity /
// Vibrance / Saturation stages of the post pass, all already normalised: black 0..40/255, white 215/255..1,
// contrast 0.5..1.5, clarity 0..1, exposure -4..4 EV, brightness -1..1, saturation 0..2 (1 = off), vibrance -1..1
// (out of range / NaN = that knob's Off). Like colour vision, any non-default knob alone makes the post pass run.
