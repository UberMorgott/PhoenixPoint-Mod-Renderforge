...
// Loads amd_fidelityfx_upscaler_dx12.dll (+ amd_fidelityfx_framegeneration_dx12.dll when present) then
// amd_fidelityfx_loader_dx12.dll from `dir` (absolute paths) and
